...
import static com.veerageolocation.api.Strings.isNullOrEmpty;
...
/**
* This is the API classe related to the Geo Location
*
...
public class VeeraGeolocationAPI {
    private String apiKey;

    public VeeraGeolocationAPI(String apiKey) throws IllegalArgumentException {
    ...
    public String buildGeolocationUrlParams(GeolocationParams params) {
